...
const speakersInfo = [
    ...
    },
    {
        ...
        title: 'Full Professor of Chemical Engineering at the Industrial Engineering Department at the University of Salerno',
...
for (let i = 0; i < speakersInfo.length; i += 1) {
    ...
    speakerImg.src = url(speakersInfo[i].photo);
